...
namespace TerrainGenerator
{
    public class TerrainChunk
    {
        ...
        public void CreateTerrain()
        {
            ...
            RootVegetablesController.instance.loadVegetable(Position, newTerrainGameObject.transform.position);
        }
        ...
        public void Remove()
        {
            ...
            RootVegetablesController.instance.hideVegetable(Position);
        }
